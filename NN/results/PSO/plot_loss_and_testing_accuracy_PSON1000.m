...
if strcmp(parameter_type, 'different_m')
    ...
    load('/Users/Konstantin/MATLAB/Research/CBOandPSO/NN/results/PSO/ShallowNN/PSOMNIST_N_1000_memory_1_lambda1_0div10_m_10div100_20epochs.mat')
    ...
    load('/Users/Konstantin/MATLAB/Research/CBOandPSO/NN/results/PSO/ShallowNN/PSOMNIST_N_1000_memory_1_lambda1_0div10_m_20div100_20epochs.mat')
    performance_tracking = performance_tracking(:,:,linspace(size(performance_tracking,3)/batches_per_epoch,size(performance_tracking,3),batches_per_epoch));
    performance_tracking_all(2,2,:,1:(epochs+1),:) = performance_tracking;
    load('/Users/Konstantin/MATLAB/Research/CBOandPSO/NN/results/PSO/ShallowNN/PSOMNIST_N_1000_memory_1_lambda1_0div10_m_40div100_20epochs.mat')
    performance_tracking = performance_tracking(:,:,linspace(size(performance_tracking,3)/batches_per_epoch,size(performance_tracking,3),batches_per_epoch));
...
elseif strcmp(parameter_type, 'different_memory')
    ...
    % load shallow NN data
    load('/Users/Konstantin/MATLAB/Research/CBOandPSO/NN/results/PSO/ShallowNN/PSOMNIST_N_1000_memory_0_lambda1_0div10_m_20div100_20epochs.mat')
    performance_tracking = performance_tracking(:,:,linspace(size(performance_tracking,3)/batches_per_epoch,size(performance_tracking,3),batches_per_epoch));
    performance_tracking_all(2,1,:,1:(epochs+1),:) = performance_tracking;
    load('/Users/Konstantin/MATLAB/Research/CBOandPSO/NN/results/PSO/ShallowNN/PSOMNIST_N_1000_memory_1_lambda1_0div10_m_20div100_20epochs.mat')
    performance_tracking = performance_tracking(:,:,linspace(size(performance_tracking,3)/batches_per_epoch,size(performance_tracking,3),batches_per_epoch));
    performance_tracking_all(2,2,:,1:(epochs+1),:) = performance_tracking;
    load('/Users/Konstantin/MATLAB/Research/CBOandPSO/NN/results/PSO/ShallowNN/PSOMNIST_N_1000_memory_1_lambda1_4div10_m_20div100_20epochs.mat')
    performance_tracking = performance_tracking(:,:,linspace(size(performance_tracking,3)/batches_per_epoch,size(performance_tracking,3),batches_per_epoch));
    performance_tracking_all(2,3,:,1:(epochs+1),:) = performance_tracking;
