% PSO illustrative
%
% This script illustrates the optimization procedure of PSO for 2d
% objective functions.
%
...
set(gcf,'color','w');
%title('Particle Swarm Optimization','Interpreter','latex','FontSize',16)  
...
fprintf("t=0\n")
%title(sprintf("PSO at time $t=0$"),'Interpreter','latex','FontSize',16)
...
for k = 1:T/dt
    ...
    t = k*dt;
    fprintf("t=%d\n", t)
    %title(sprintf("PSO at time $t=%d$",t),'Interpreter','latex','FontSize',16)
...
%% Save Video
if savevideo
    video = VideoWriter(['EnergyBasedPSOAnalysis/images_videos/PSOIllustrative_',objectivefunction],'MPEG-4');
    video.FrameRate = 8;
    open(video);
