% An illustration of the PSO dynamics
%
% This script visualizes the terms steering the dynamics of PSO.
%
...
% % friction term
friction_scaling = 1;
friction_direction = (-gamma)*friction_scaling*[X(1,1)-X_history0(1,end); X(2,1)-X_history0(2,end)]*dt;
quiver(X(1,1),X(2,1), friction_direction(1,1),friction_direction(2,1), 'LineWidth', 1.6, "color", co(4,:)); hold on
